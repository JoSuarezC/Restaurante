...
public class ClientOrder_Controller {
    ...
    private void checkProduct(Product selection){
        ...
        if(indice != -1){
            ...
            tablaView_Inventario.getItems().add(new ShoppingList_Product(selection.getProductName(), selection.getProductType(), selection.getProductID(), selection.getProductPrize(), selection.getProductDetail(), Integer.parseInt(TextBox_ProductQuantity.getText()), selection.getProductState()));
        }
    }
